...
// Program : showing how the protected access modifier affects visibility of the variables
// Version : 7.4

package lesson3.inheritance_code_examples.ex04;

public class RatingChannel
{
	protected String channelName;
	protected int channelNumber;
	protected double grossWeeklyRating;
	protected double profitRate; // profit percentage
