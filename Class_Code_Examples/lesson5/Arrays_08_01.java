...
public class Arrays_08_01 {
	...
	public Arrays_08_01() {
		// initialize both arrays according to the size of the "evenIntegers"
		// array
		// will initially get filled with zeroes according to the default value
		// for integers
	...
	public void findInteger(int value) {
		int index = Arrays.binarySearch(evenIntegers, value); // requires a
																// sorted array,
																// returns a
																// negative
																// index if
	...
	public static void main(String args[]) {
		...
		Arrays.fill(filledOddIntegers, 1); // fill the "filledOddIntegers" array
											// with the value 1
		Arrays.sort(oddDoubles); // sort oddDoubles in a default ascending order

		// notice there are more static methods for manipulating arrays (this
		// one is from "System")
		// not all of them found in the "Arrays" class and not all of them found
		...
		System.arraycopy(evenIntegers, 0, evenIntegersCopy, 0,
				evenIntegers.length);
 ...
 ****************************************************************
 * Disclaimer: The author of the sourcecodes and presentations * has done his
 * best to provide you with good explanations * and examples to allow you an
 * educational and beneficial * walk through over the materials of the class. *
 * With that said, the author makes no warranty of any kind, * expressed or
 * implied, with regard to these programs or to * the documentation contained in
 * his lectures and sourcecodes. * The author shall not be held responsible in
 * any way in event * of any incidental or consequential damages arising out of
